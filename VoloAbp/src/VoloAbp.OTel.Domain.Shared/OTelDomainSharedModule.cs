...
public class OTelDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        OTelGlobalFeatureConfigurator.Configure();
        OTelModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<OTelDomainSharedModule>();
        });
        ...
        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                ...
                .AddVirtualJson("/Localization/OTel");

            options.DefaultResourceType = typeof(OTelResource);
        ...
        {
            options.MapCodeNamespace("OTel", typeof(OTelResource));
        });
    }
}
