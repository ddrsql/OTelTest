...
namespace VoloAbp.OTel.Migrations
{
    ...
    [Migration("20260102093648_Add_TestSuite")]
    partial class Add_TestSuite
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VoloAbp.OTel.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("VoloAbp.OTel.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("VoloAbp.OTel.TestSuites.Aggregates.TestSuite", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");

                    b.Property<long?>("AverageExecutionTime")
            ...
            modelBuilder.Entity("VoloAbp.OTel.Books.Book", b =>
                {
                    b.HasOne("VoloAbp.OTel.Authors.Author", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VoloAbp.OTel.TestSuites.Aggregates.TestSuite", b =>
                {
                    b.OwnsMany("VoloAbp.OTel.TestSuites.Aggregates.TestCase", "TestCases", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("char(36)");

                            b1.Property<Guid>("TestSuiteId")
                                .HasColumnType("char(36)");

                            b1.Property<string>("ActualResult")
                                .HasColumnType("longtext");
                            ...
                            b1.Property<DateTime?>("LastRunTime")
                                .HasColumnType("datetime(6)");
                            ...
                            b1.HasKey("Id", "TestSuiteId");

                            b1.HasIndex("LastRunTime");

                            b1.HasIndex("Status");

                            b1.HasIndex("TestSuiteId");
                            ...
                            b1.OwnsOne("VoloAbp.OTel.TestSuites.Aggregates.TestPriority", "Priority", b2 =>
                                {
                                    b2.Property<Guid>("TestCaseId")
                                        .HasColumnType("char(36)");

                                    b2.Property<Guid>("TestCaseTestSuiteId")
                                        .HasColumnType("char(36)");
                                    ...
                                    b2.HasKey("TestCaseId", "TestCaseTestSuiteId");

                                    b2.ToTable("TestCases");

                                    b2.WithOwner()
                                        .HasForeignKey("TestCaseId", "TestCaseTestSuiteId");
                                });
                    ...
                    b.OwnsOne("VoloAbp.OTel.TestSuites.Aggregates.TestConfiguration", "Configuration", b1 =>
                        {
                            b1.Property<Guid>("TestSuiteId")
                                .HasColumnType("char(36)");

                            b1.Property<bool>("EnableParallelExecution")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("tinyint(1)")
                                .HasDefaultValue(false)
                            ...
                            b1.Property<int>("TimeoutInSeconds")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int")
                                .HasDefaultValue(30)
                                .HasColumnName("TimeoutInSeconds");

                            b1.HasKey("TestSuiteId");

                            b1.ToTable("TestSuiteConfigurations", (string)null);
