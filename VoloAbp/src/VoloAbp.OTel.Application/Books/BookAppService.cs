...
[Authorize(OTelPermissions.Books.Default)]
    ...
    , IOTelActivityEnabled
{
        ...
        : base(repository)
    {
        ...
        GetPolicyName = OTelPermissions.Books.Default;
        GetListPolicyName = OTelPermissions.Books.Default;
        CreatePolicyName = OTelPermissions.Books.Create;
        UpdatePolicyName = OTelPermissions.Books.Edit;
        DeletePolicyName = OTelPermissions.Books.Delete;
    }
