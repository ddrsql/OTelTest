...
using AbpCore.OTel.Models.TokenAuth;
...
public abstract class OTelWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static OTelWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(OTelWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<OTelDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<OTelDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<OTelDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<OTelDbContext, Task<T>> func)
    {
        T result;
