...
namespace AbpCore.OTel.Migrations
{
    ...
    [Migration("20260224143639_Add_Task")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AbpCore.OTel.Tasks.Task", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("AbpCore.OTel.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("AbpCore.OTel.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("AbpCore.OTel.Tasks.Task", b =>
                {
                    b.HasOne("AbpCore.OTel.Authorization.Users.User", "AssignedUser")
                        .WithMany()
