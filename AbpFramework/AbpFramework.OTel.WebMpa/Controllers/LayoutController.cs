...
using Abp.Threading;
using AbpFramework.OTel.Configuration;
using AbpFramework.OTel.Configuration.Ui;
using AbpFramework.OTel.Sessions;
using AbpFramework.OTel.WebMpa.Models;
using AbpFramework.OTel.WebMpa.Models.Layout;

namespace AbpFramework.OTel.WebMpa.Controllers
{
    public class LayoutController : OTelControllerBase
    {
