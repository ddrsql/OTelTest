        ...
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        ExceptionMessage = c.String(maxLength: 1024, storeType: "nvarchar"),
                ...
                c => new
                    {
                        ...
                        EntityFullName = c.String(maxLength: 250, storeType: "nvarchar"),
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        PropertyName = c.String(maxLength: 250, storeType: "nvarchar"),
                ...
                c => new
                    {
                        Id = c.Long(nullable: false, identity: true),
                        Value = c.String(nullable: false, unicode: false),
                        EntityId = c.String(unicode: false),
                ...
                c => new
                    {
                        ...
                        TenantId = c.Int(),
                        NewValueHash = c.String(unicode: false),
                        OriginalValueHash = c.String(unicode: false),
                    },
                annotations: new Dictionary<string, object>
                {
                ...
                c => new
                    {
                        Id = c.Long(nullable: false, identity: true),
                        TenantId = c.Int(),
                        LanguageName = c.String(nullable: false, maxLength: 128, storeType: "nvarchar"),
                ...
                c => new
                    {
                        ...
                        TargetNotifiers = c.String(unicode: false),
                        CreationTime = c.DateTime(nullable: false, precision: 0),
                        CreatorUserId = c.Long(),
                    })
                .PrimaryKey(t => t.Id);
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Guid(nullable: false),
                        WebhookName = c.String(nullable: false, unicode: false),
                        Data = c.String(unicode: false),
                        CreationTime = c.DateTime(nullable: false, precision: 0),
                        TenantId = c.Int(),
                        IsDeleted = c.Boolean(nullable: false),
                ...
                c => new
                    {
                        Id = c.Guid(nullable: false),
                        TenantId = c.Int(),
                        WebhookUri = c.String(nullable: false, unicode: false),
                        Secret = c.String(nullable: false, unicode: false),
                        IsActive = c.Boolean(nullable: false),
                        Webhooks = c.String(unicode: false),
                        Headers = c.String(unicode: false),
                        CreationTime = c.DateTime(nullable: false, precision: 0),
                        CreatorUserId = c.Long(),
                    })
                .PrimaryKey(t => t.Id);
